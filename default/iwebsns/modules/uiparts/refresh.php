...
if(filemtime("templates/default/modules/uiparts/refresh.html") > filemtime(__file__) || (file_exists("models/modules/uiparts/refresh.php") && filemtime("models/modules/uiparts/refresh.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/uiparts/refresh.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
