...
if(filemtime("templates/default/modules/group/group_mine.html") > filemtime(__file__) || (file_exists("models/modules/group/group_mine.php") && filemtime("models/modules/group/group_mine.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/group/group_mine.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<body id="iframecontent">
  ...
  <?php if(is_admin($ses_uid)=='Y'){?><div class="create_button"><a href="modules.php?app=group_creat"><?php echo $g_langpackage->g_creat;?></a></div>
  <div class="create_button"><a href="modules.php?app=group_budget_manager&group_id=18" target="_blank"><?php echo $g_langpackage->g_budget;?></a></div><?php }?>
  <?php }?>
