...
if(filemtime("templates/default/modules/msgscrip/notice.html") > filemtime(__file__) || (file_exists("models/modules/msgscrip/notice.php") && filemtime("models/modules/msgscrip/notice.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/msgscrip/notice.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
