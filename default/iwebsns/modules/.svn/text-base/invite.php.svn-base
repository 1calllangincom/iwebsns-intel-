...
if(filemtime("templates/default/modules/invite.html") > filemtime(__file__) || (file_exists("models/modules/invite.php") && filemtime("models/modules/invite.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/invite.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
