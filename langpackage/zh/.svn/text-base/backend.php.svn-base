...
class foundationlp{
	...
	var $f_set="通过登录管理平台，您可以对站点的参数进行设置。";
	var $f_data_num="站点数据统计";
	var $f_people_num="注册人数";
	var $f_group_num="俱乐部总数";
	...
	var $f_team="开发及测试";
	var $f_copyright="版权所有：Intel chengdu";
	var $f_ceo="系统设计";
	var $f_art="主题及UI";
	var $f_web="网站";
	...
	var $f_site_name_annotations="网站标题";
	var $f_check_domain="程序检测访问地址：";
	var $f_tip_domain="您设置的<站点访问地址>项与程序检测的路径不同，所以推荐好友，flash上传照片，添加收藏等功能会因此而无法找到正确的路径！\\n\\n您确定还要修改么？";
	var $f_keyword_annotations="（便于引擎查找，当输入多个时，用“，”或者“|”分隔。如：intel,chengdu）";
	var $f_description_annotations="（网站的重点描述信息，让访客清楚了解网站概要。如：intel chengdu）";
	var $f_click_set="点击设置完整地址";
	var $f_copyright_inf_annotations="（网站所属的版权。如：Copyright©2011 Intel chengdu）";
	...
	var $f_group_admin_annotations="（俱乐部所能设定的管理员数量。默认：3）";
	var $f_my_group_num_annotations="（每个用户所能创建俱乐部数量。默认：3）";
...
class uilp{
	var	$u_get_false="获取远程模板列表失败，请您稍后再试";
...
class softwarelp{
	var $so_tip_inf="提示信息";
	var $so_list_false="获取升级列表失败";
	var $so_last_version="";
	var $so_update_list="列表";
	var $so_soft_version="版本";
	var $so_time="时间";
	var $so_ctrl="操作";
	var $so_ask_update="你确定要直接升级到此版本么？";
	var $so_act_update="升级到此版本";
