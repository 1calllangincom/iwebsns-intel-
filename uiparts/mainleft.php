...
if(filemtime("templates/default/uiparts/mainleft.html") > filemtime(__file__) || (file_exists("models/uiparts/mainleft.php") && filemtime("models/uiparts/mainleft.php") > filemtime(__file__)) ) {
	tpl_engine("default","uiparts/mainleft.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
