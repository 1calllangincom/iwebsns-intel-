...
if(filemtime("templates/default/modules/group/group_select.html") > filemtime(__file__) || (file_exists("models/modules/group/group_select.php") && filemtime("models/modules/group/group_select.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/group/group_select.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
