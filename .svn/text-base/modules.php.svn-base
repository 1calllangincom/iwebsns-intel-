...
$appArray=array(
		   ...
		   "group_budget" => 'modules/group/group_budget.php',
		   "group_budget_manager" => 'modules/group/group_budget_manager.php',
		   "group_budget_search" => 'modules/group/budget_forcast_search.php',
		   ...
		   "event_excel" => 'modules/event/event_excel.php',
		   "event_messages" => 'modules/event/event_messages.php',
		   "event_quick" => 'modules/event/event_quick.php',
		   ...
		   "ask_reply" => 'modules/ask/ask_reply.php',
			...
			"hello"=> 'modules/helloworld/helloworld_list.php',
			"square" => 'modules/square/square.php'
       );
