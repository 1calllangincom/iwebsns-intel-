...
if(filemtime("templates/default/modules/mypals/pals_fribirth_month.html") > filemtime(__file__) || (file_exists("models/modules/mypals/pals_fribirth_month.php") && filemtime("models/modules/mypals/pals_fribirth_month.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/mypals/pals_fribirth_month.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
