...
if(filemtime("templates/default/modules/userapp/mag_app.html") > filemtime(__file__) || (file_exists("models/modules/userapp/mag_app.php") && filemtime("models/modules/userapp/mag_app.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/userapp/mag_app.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
