...
if(filemtime("templates/default/modules/msgscrip/creator.html") > filemtime(__file__) || (file_exists("models/modules/msgscrip/creator.php") && filemtime("models/modules/msgscrip/creator.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/msgscrip/creator.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
