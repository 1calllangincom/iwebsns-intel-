...
if(filemtime("templates/default/modules/poll/poll_show_config.html") > filemtime(__file__) || (file_exists("models/modules/poll/poll_show_config.php") && filemtime("models/modules/poll/poll_show_config.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/poll/poll_show_config.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
