...
if(filemtime("templates/default/modules/restore/get_restore.html") > filemtime(__file__) || (file_exists("models/modules/restore/get_restore.php") && filemtime("models/modules/restore/get_restore.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/restore/get_restore.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
