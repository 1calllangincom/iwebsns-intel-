...
if(filemtime("templates/default/modules/mypals/search_pals_list.html") > filemtime(__file__) || (file_exists("models/modules/mypals/search_pals_list.php") && filemtime("models/modules/mypals/search_pals_list.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/mypals/search_pals_list.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
