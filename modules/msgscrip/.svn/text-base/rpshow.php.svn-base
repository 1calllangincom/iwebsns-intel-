...
if(filemtime("templates/default/modules/msgscrip/rpshow.html") > filemtime(__file__) || (file_exists("models/modules/msgscrip/rpshow.php") && filemtime("models/modules/msgscrip/rpshow.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/msgscrip/rpshow.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
