...
if(filemtime("templates/default/modules/album/photo_view.html") > filemtime(__file__) || (file_exists("models/modules/album/photo_view.php") && filemtime("models/modules/album/photo_view.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/album/photo_view.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
