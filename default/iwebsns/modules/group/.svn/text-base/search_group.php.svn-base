...
if(filemtime("templates/default/modules/group/search_group.html") > filemtime(__file__) || (file_exists("models/modules/group/search_group.php") && filemtime("models/modules/group/search_group.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/group/search_group.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
