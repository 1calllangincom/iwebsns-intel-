...
if(filemtime("templates/default/modules/users/user_activate_succ.html") > filemtime(__file__) || (file_exists("models/modules/users/user_activate_succ.php") && filemtime("models/modules/users/user_activate_succ.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/users/user_activate_succ.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
