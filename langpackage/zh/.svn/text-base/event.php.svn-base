...
class event_frontlp{
	...
	var $ef_activity_mail= "通知俱乐部";
	var $ef_activity_baoming="通知报名者";
	var $ef_activity_href="报名网址";
	var $ef_search = "搜索";
	...
	var $ef_participated_activity = "您报名了此活动";
	...
	var $ef_activity_already_check = "您已经报到";
	var $ef_activity_already_check_no = "您没有参与活动";
	...
	var $ef_activity_number_ef_limit = "活动报名人数限制，设为 0 表示无限制。";
	...
	var $ef_participation_requires_approval = "报名活动需要审批";
	var $ef_allowed_bring_friends = "允许报名者携带朋友，携带朋友数会占用活动参与者名额";
	...
	var $ef_select_activity_club = "请选择俱乐部";
	...
	var $ef_people_participate = "人报名";
	var $ef_people_attention = "人关注";
	var $ef_member = "成员";
	var $ef_photo = "照片";
	var $ef_upload_photo = "上传照片";
	var $ef_event_table="活动报表";
	var $ef_event_messages="活动通知";
	var $ef_come_from = "来自";
	...
	var $ef_messages_join="通知报名者";
	var $ef_messages_send="发送";
	var $ef_excel = "报表";
	var $ef_name = "名字";
	var $ef_sex = "性别";
	var $ef_operation = "操作";
	...
	var $ef_i_is = "我是";
	var $ef_no_activity_you_can = "对不起,没有相关活动";
	...
	var $ef_trend="参与趋势";
	var $ef_cost="成本效益";
	var $ef_diversity="参与多元化";
	var $ef_gender="性别比例";
	var $ef_department="部门比例";
	var $ef_factory="工厂比例";
	var $ef_sc="员工俱乐部考察";
	var $ef_total="总分数";
	var $ef_c_safety="参与评选必须没有安全或COC问题";
	var $ef_c_cost="总成本/总报名人数";
	var $ef_c_gender="M/F";
	var $ef_c_department="# of departments";
	var $ef_c_factory="# of factory";
	var $ef_c_sc="座谈会的反馈";
	var $ef_data="数值";
}
...
class event_actionlp{
	...
	var $ea_no_wwid="您输入的WWID没有注册";
	var $ea_no_event="没有您输入的活动编号";
	var $ea_not_participate_activity = "您没有报名此活动!";
