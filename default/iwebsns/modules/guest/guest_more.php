...
if(filemtime("templates/default/modules/guest/guest_more.html") > filemtime(__file__) || (file_exists("models/modules/guest/guest_more.php") && filemtime("models/modules/guest/guest_more.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/guest/guest_more.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
