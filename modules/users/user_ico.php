...
if(filemtime("templates/default/modules/users/user_ico.html") > filemtime(__file__) || (file_exists("models/modules/users/user_ico.php") && filemtime("models/modules/users/user_ico.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/users/user_ico.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php 
