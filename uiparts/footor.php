...
if(filemtime("templates/default/uiparts/footor.html") > filemtime(__file__) || (file_exists("models/uiparts/footor.php") && filemtime("models/uiparts/footor.php") > filemtime(__file__)) ) {
	tpl_engine("default","uiparts/footor.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="foot">
	...
	<a href="mailto:<?php echo $adminEmail;?>"><?php echo $pu_langpackage->pu_email;?></a></div>
