...
if(filemtime("templates/default/modules/ask/ask_edit.html") > filemtime(__file__) || (file_exists("models/modules/ask/ask_edit.php") && filemtime("models/modules/ask/ask_edit.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/ask/ask_edit.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
