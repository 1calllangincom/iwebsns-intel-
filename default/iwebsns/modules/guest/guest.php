...
if(filemtime("templates/default/modules/guest/guest.html") > filemtime(__file__) || (file_exists("models/modules/guest/guest.php") && filemtime("models/modules/guest/guest.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/guest/guest.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
