...
if(filemtime("templates/default/modules/poll/poll_mine.html") > filemtime(__file__) || (file_exists("models/modules/poll/poll_mine.php") && filemtime("models/modules/poll/poll_mine.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/poll/poll_mine.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
