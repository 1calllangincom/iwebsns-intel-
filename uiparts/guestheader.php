...
if(filemtime("templates/default/uiparts/guestheader.html") > filemtime(__file__) || (file_exists("models/uiparts/guestheader.php") && filemtime("models/uiparts/guestheader.php") > filemtime(__file__)) ) {
	tpl_engine("default","uiparts/guestheader.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="top_bg">
	<div class="nav">
	  <span class="left">
	    ...
	    <a href="modules.php?app=square">访客广场</a>
	    
                  <a href="modules.php?app=about&mod=0" target="_blank">关于俱乐部</a>
