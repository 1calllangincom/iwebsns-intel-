...
if(filemtime("templates/default/modules/share/share_list.html") > filemtime(__file__) || (file_exists("models/modules/share/share_list.php") && filemtime("models/modules/share/share_list.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/share/share_list.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
