...
<title><?php echo $holder_name;?>的个人俱乐部生涯-<?php echo $siteName;?></title>
...
<div class="home_start"><?php require($inc_header);?>
<div class="user_box">
...
<div id="home_tabs" class="tabs">
  <ul class="menu">
	  ...
	  <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=group&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_groups;?></a></li>
	      <li><a href="javascript:void(0);" onclick="frame_content.location.href='<?php echo $siteDomain;?>modules.php?app=event&user_id=<?php echo $holder_id;?>';return false;" hidefocus="true"><?php echo $ah_langpackage->ah_events;?></a></li>
