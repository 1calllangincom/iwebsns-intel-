...
if(filemtime("templates/default/modules/msgboard/msgboard.html") > filemtime(__file__) || (file_exists("models/modules/msgboard/msgboard.php") && filemtime("models/modules/msgboard/msgboard.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/msgboard/msgboard.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
