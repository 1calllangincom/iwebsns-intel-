...
if(filemtime("templates/default/uiparts/homeleft.html") > filemtime(__file__) || (file_exists("models/uiparts/homeleft.php") && filemtime("models/uiparts/homeleft.php") > filemtime(__file__)) ) {
	tpl_engine("default","uiparts/homeleft.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<div class="homeside">
	...
	<div class="userinfo">
		<dl>
			...
			<dd><?php echo $u_langpackage->u_wwid;?>：<span><?php echo $user_info["wwid"]?$user_info["wwid"]:$u_langpackage->u_set;?></span></dd>
