<?php
  ...
  $blog_sort_name=short_check(get_argp('blog_sort_name'));
	...
	$sql= "update $t_blog set img='$img',log_title='$ulog_title',privacy='$privacy',log_sort='$ulog_sort',log_content='$ulog_txt',edit_time='".constant('NOWTIME')."',log_sort_name='$blog_sort_name',tag='$tag' where user_id=$user_id and log_id=$ulog_id";
