<?php
  ...
  plugin_submit_form();//plugins表单分发
	$sql="insert into $t_blog (user_id,log_title,log_sort,log_content,add_time,log_sort_name,user_name,user_ico,privacy,`tag`,img) values ($user_id,'$ulog_title',$ulog_sort,'$ulog_txt','".constant('NOWTIME')."','$blog_sort_name','$user_name','$uico_url','$privacy','$tag','$img')";
