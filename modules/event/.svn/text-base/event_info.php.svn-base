...
if(filemtime("templates/default/modules/event/event_info.html") > filemtime(__file__) || (file_exists("models/modules/event/event_info.php") && filemtime("models/modules/event/event_info.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/event/event_info.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
  ...
  <div class="tabs">
	...
	<form action="<?php echo $action;?>" method="post" enctype="multipart/form-data" onsubmit="return validate(this);">
	    <table class="form_table">
	        ...
	        <tr>
        	<th><?php echo $ef_langpackage->ef_group_name;?>：</th>
            <td><?php echo $event_group_name;?></td>
        </tr>
<!--        <tr>-->
...
<!--        </tr>-->
        ...
        <input name="public" id="public" type="hidden" value="2"></input>
        <!--<tr>
...
//	}
	...
	if(!formObj.group_id.value){
		parent.Dialog.alert("<?php echo $ef_langpackage->ef_select_activity_club;?>");
		return false;
	}
