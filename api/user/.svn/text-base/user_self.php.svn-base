...
function user_read_base($fields="*",$condition="",$get_type="",$num="",$by_col="user_id",$order="desc",$cache="",$cache_key=""){
  ...
  dbplugin('r');
	$allow_cols=array(
		"user_id","user_email","user_name","user_sex","birth_province","birth_city","reside_province","reside_city","user_ico","user_add_time","birth_year","birth_month","birth_day","creat_group","join_group","guest_num","integral","lastlogin_datetime","hidden_pals_id","hidden_type_id","inputmess_limit","palsreq_limit","is_pass","access_limit","access_questions","access_answers","forget_pass","wwid","user_group"
	);
  $limit=$num ? " limit $num ":"";
