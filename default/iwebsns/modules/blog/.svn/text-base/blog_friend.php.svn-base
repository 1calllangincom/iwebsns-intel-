...
if(filemtime("templates/default/modules/blog/blog_friend.html") > filemtime(__file__) || (file_exists("models/modules/blog/blog_friend.php") && filemtime("models/modules/blog/blog_friend.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/blog/blog_friend.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
