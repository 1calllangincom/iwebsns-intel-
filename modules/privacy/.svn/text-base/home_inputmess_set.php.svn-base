...
if(filemtime("templates/default/modules/privacy/home_inputmess_set.html") > filemtime(__file__) || (file_exists("models/modules/privacy/home_inputmess_set.php") && filemtime("models/modules/privacy/home_inputmess_set.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/privacy/home_inputmess_set.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
