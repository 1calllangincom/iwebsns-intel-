...
if(filemtime("templates/default/modules/event/event_invite.html") > filemtime(__file__) || (file_exists("models/modules/event/event_invite.php") && filemtime("models/modules/event/event_invite.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/event/event_invite.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
