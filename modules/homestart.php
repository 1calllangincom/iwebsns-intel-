...
if(filemtime("templates/default/modules/homestart.html") > filemtime(__file__) || (file_exists("models/modules/homestart.php") && filemtime("models/modules/homestart.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/homestart.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
