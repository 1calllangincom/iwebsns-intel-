...
if(filemtime("templates/default/modules/blog/blog_show.html") > filemtime(__file__) || (file_exists("models/modules/blog/blog_show.php") && filemtime("models/modules/blog/blog_show.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/blog/blog_show.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
