...
if(filemtime("templates/default/modules/blog/blog_edit.html") > filemtime(__file__) || (file_exists("models/modules/blog/blog_edit.php") && filemtime("models/modules/blog/blog_edit.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/blog/blog_edit.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
	    ...
	    <tr>
			...
			<tr>
     		...
     		<tr>
     		    <?php if($is_admin=='Y'){?>
      <tr>
      	<th><?php echo $b_langpackage->b_img;?>：</th>
      	<td><input type='text' class='med-text' name='img' value='<?php echo $img_url;?>' /></td>
      </tr>
      	<?php }?>
			<th></th>
			<td colspan="2">
