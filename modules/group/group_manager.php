...
if(filemtime("templates/default/modules/group/group_manager.html") > filemtime(__file__) || (file_exists("models/modules/group/group_manager.php") && filemtime("models/modules/group/group_manager.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/group/group_manager.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
	...
	$sql="select count(event_id) from isns_event where group_id=$group_id";
	$event_count=$dbo->getRow($sql);
...
<body id="iframecontent">
    ...
    <div class="tabs">
        <ul class="menu">
            ...
            <li><a href="modules.php?app=group_budget&group_id=<?php echo $group_id;?>" target="_blank" title="<?php echo $g_langpackage->g_budget;?>"><?php echo $g_langpackage->g_budget;?></a></li>
        </ul>
    </div>
...
<table class='form_table <?php echo $content_list;?>'>		
			...
			<tr>
				<th><?php echo $g_langpackage->g_e_num;?></th>
				<td><?php echo $event_count['count(event_id)'];?></td>
			</tr>
