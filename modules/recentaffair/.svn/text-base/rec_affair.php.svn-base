...
if(filemtime("templates/default/modules/recentaffair/rec_affair.html") > filemtime(__file__) || (file_exists("models/modules/recentaffair/rec_affair.php") && filemtime("models/modules/recentaffair/rec_affair.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/recentaffair/rec_affair.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
