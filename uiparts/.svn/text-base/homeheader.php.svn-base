...
if(filemtime("templates/default/uiparts/homeheader.html") > filemtime(__file__) || (file_exists("models/uiparts/homeheader.php") && filemtime("models/uiparts/homeheader.php") > filemtime(__file__)) ) {
	tpl_engine("default","uiparts/homeheader.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<!--                <dt><a href="modules.php?app=square"><?php echo $mn_langpackage->mn_guangchang;?></a></dt>-->
                ...
                <dt onmouseover="apMenuShow(true);" onmouseout="apMenuShow(false);">
                    ...
                    <ul class="ap_menu" id="ap_menu" style="display:none;" onmouseover="apMenuShow(true);" onmouseout="apMenuShow(false);">
                        ...
                        <li><span class="am_left"><img src="skin/<?php echo $skinUrl;?>/images/group.gif" /></span><span class="am_center"><a href="main.php?app=group" hidefocus="true"><?php echo $mn_langpackage->mn_group;?></a></span></li>
