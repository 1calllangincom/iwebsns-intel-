...
if(filemtime("templates/default/modules/default.html") > filemtime(__file__) || (file_exists("models/modules/default.php") && filemtime("models/modules/default.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/default.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
