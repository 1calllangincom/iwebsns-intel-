...
$actArray=array(
	...
	"group_budget_add"=> array('action/group/group_budget_add.action.php'),
	"group_budget_del"=> array('action/group/group_budget_del.action.php'),
	"group_forcast_add"=> array('action/group/group_forcast_add.action.php'),
	"group_forcast_del"=> array('action/group/group_forcast_del.action.php'),
	"group_budget_approve"=> array('action/group/group_budget_manager_approve.action.php'),
	"group_budget_disapprove"=> array('action/group/group_budget_manager_disapprove.action.php'),
	"group_forcast_approve"=> array('action/group/group_forcast_manager_approve.action.php'),
	"group_forcast_disapprove"=> array('action/group/group_forcast_manager_disapprove.action.php'),
	"group_forcast_year"=> array('action/group/group_forcast_year.action.php'),
	...
	"event_check_del" => array('action/event/event_check_del.php'),
	"event_messages_crt" => array('action/event/event_messages_crt.action.php','modules.php?app=event'),
	"event_quick" => array('action/event/event_quick.action.php'),	
	...
	"hello_del" => array('action/helloworld/helloworld_del.action.php','modules.php?app=hello'),
	"hello_add" => array('action/helloworld/helloworld_add.action.php','modules.php?app=hello'),

);
$actId=getActId();
$free_act_array=array("login","event_quick","reg","logout","pr_access_login","photo_upl_flash","user_forget","user_pw_change","user_activation");
//除必须登录才能访问文件
