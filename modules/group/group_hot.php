...
if(filemtime("templates/default/modules/group/group_hot.html") > filemtime(__file__) || (file_exists("models/modules/group/group_hot.php") && filemtime("models/modules/group/group_hot.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/group/group_hot.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
...
<body id="iframecontent">
    ...
    <?php if(is_admin($user_id)=='Y'){?><div class="create_button"><a href="modules.php?app=group_creat"><?php echo $g_langpackage->g_creat;?></a></div> <div class="create_button"><a href="modules.php?app=group_budget" target="_blank"><?php echo $g_langpackage->g_budget;?></a></div><?php }?>
