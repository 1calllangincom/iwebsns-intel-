...
if(filemtime("templates/default/modules/users/affair_set.html") > filemtime(__file__) || (file_exists("models/modules/users/affair_set.php") && filemtime("models/modules/users/affair_set.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/users/affair_set.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
