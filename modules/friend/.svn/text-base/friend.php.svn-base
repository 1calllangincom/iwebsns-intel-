...
if(filemtime("templates/default/modules/friend/friend.html") > filemtime(__file__) || (file_exists("models/modules/friend/friend.php") && filemtime("models/modules/friend/friend.php") > filemtime(__file__)) ) {
	tpl_engine("default","modules/friend/friend.html",1);
	include(__file__);
}else {
/* debug模式运行生成代码 结束 */
?><?php
